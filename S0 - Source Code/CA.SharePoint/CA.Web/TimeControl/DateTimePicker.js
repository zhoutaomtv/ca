...
//客户端脚本采用以下作者的代码,下载自：http://dev.csdn.net/develop/article/65/65724.shtm
//----------------------------------------------------------------------
//
// 作者: 李淼（Nick.Lee）
//
...
window.frames.DateTimePicker_DateLayer.document.close();  //解决ie进度条不结束的问题

//==================================================== WEB 页面显示部分 ======================================================
var outObject;
var outButton;  //点击的按钮
var outDate="";  //存放对象的日期
var odatelayer=window.frames.DateTimePicker_DateLayer.document.all;  //存放日历对象
function DateTimePicker_setday(tt,obj) //主调函数
{
