...
function WebCalendar() //初始化日历的设置
{
    ...
    //自定义类别
    this.SelectedImgUrl= DatePicker_ImageFolder + "bgCurDate.gif" ;
    this.ToDayImgUrl= DatePicker_ImageFolder+ "bgToday1.gif" ;
    this.SetectedToDayImgUrl= DatePicker_ImageFolder + "bgToday2.gif" ;
    this.LeftUpImgUrl= DatePicker_ImageFolder + "left_up.gif" ;
    this.LeftDownImgUrl=DatePicker_ImageFolder+"left_down.gif" ;
    this.RightUpImgUrl=DatePicker_ImageFolder+"right_up.gif" ;
    this.RightDownImgUrl=DatePicker_ImageFolder+"right_down.gif" ; 
...
function TimePicker_Select( id )
{
var obj = document.getElementById(id);
 calendar(obj);
}

function TimePicker_Clear( id )
{
var obj = document.getElementById(id);
obj.value = "";
}
