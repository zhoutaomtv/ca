<%@ Page Title="" Language="C#" MasterPageFile="~/_Layouts/CA/Application.Master"
    EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ApplicantEditForm.aspx.cs"
    Inherits="CA.WorkFlows.ITHardwareOrSoftwareApplication.ApplicantEditForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWorkFlowName"
    runat="server">
    IT HW/SW Application-IT硬件或软件申请
</asp:Content>
                    ...
                    <table width="680" border="0" align="left" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" id="tblCommentsList"
                                    runat="server">
                                    <tr>
                                        <td>
                                ...
                                <table width="596" border="0" align="center" cellpadding="0" cellspacing="0" class="note">
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <a href="/WorkFlowCenter/FlowCharts/ITRequest.doc" style="cursor: hand; color: Blue;
