<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DataFormNew.ascx.cs" Inherits="CA.WorkFlow.UI.TimeOff.DataFormNew" %>
...
<table runat="server" id="tableNew" width="100%" border="0" cellpadding="0" cellspacing="0"
    ...
    <tr>
        ...
        <td>
        <asp:TextBox runat="server" ID="txtEmplyeeNum"></asp:TextBox>            
        </td>
    </tr>
</table>
