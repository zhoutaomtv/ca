<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DataForm.ascx.cs" Inherits="CA.WorkFlow.UI.SupplierReticketing.DataForm" %>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" class="workflow_table3">
    <tr>
        <th>
            <p>
        ...
        <th>
            <p>
                Buying User<span class="ms-formvalidation"> *</span></p>
            <p>
                采购员</p>
        </th>
    </tr>
    <tr>
        ...
        <td style="width: 40%">
            <cc1:CAPeopleFinder ID="cpfBuyingUser" runat="server" AllowTypeIn="true" MultiSelect="false"
                Width="95%" />
        </td>
    </tr>
</table>
