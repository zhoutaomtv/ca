<%@ Page Language="C#" MasterPageFile="~/_Layouts/CA/Application.Master" AutoEventWireup="true" CodeBehind="NewForm.aspx.cs" Inherits="CA.WorkFlow.UI.StoreMaintenance.NewForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderWorkFlowName" runat="server">
    Store Maintenance Request- 店铺维修申请 
</asp:Content>
                    ...
                    <table width="680" border="0" align="left" cellpadding="0" cellspacing="0" >
                        <tr>
                            <td class="workflow_table_button"  style="padding-bottom:10px">
                                <QFC:StartWorkflowButton ID="StartWorkflowButton1" runat="server" Text="Submit" OnClientClick="return validForm();" />
                        ...
                        <tr>
                            <td>
                                ...
                                <table width="596" border="0" align="center" cellpadding="0" cellspacing="0" class="note">
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <a href="/WorkFlowCenter/FlowCharts/StoreMaintenance.doc" style="cursor:hand; color:Blue; font-size:14px">Click here to view the flowchart of the workflow</a>
                                        </td>
                                    </tr>
                                    <tr>
