<%@ Page Language="C#" MasterPageFile="~/_Layouts/CA/Application.Master" AutoEventWireup="true"
    CodeBehind="EditForm.aspx.cs" Inherits="CA.WorkFlow.UI.StoreMaintenance.EditForm" %>
            ...
            <tr>
                <td>
                    <div class="workflow_table_button" style="padding-bottom: 10px">
                        <QFC:ActionsButton ID="actions" runat="server" OnClientClick="return validForm();" />
                            ...
                            <td>
                                ...
                                <asp:Panel runat="server" ID="PFC">
                                    <table width="596" border="0" align="center" cellpadding="0" cellspacing="0" class="note">
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <a href="/WorkFlowCenter/FlowCharts/StoreMaintenance.doc" style="cursor: hand; color: Blue;
