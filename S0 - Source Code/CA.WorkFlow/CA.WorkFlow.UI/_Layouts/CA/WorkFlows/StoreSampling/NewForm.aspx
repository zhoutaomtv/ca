<%@ Page Language="C#" MasterPageFile="~/_Layouts/CA/Application.Master" AutoEventWireup="true" CodeBehind="NewForm.aspx.cs" Inherits="CA.WorkFlow.UI._Layouts.CA.WorkFlows.StoreSampling.NewForm" %>
                        ...
                        <tr>
                            <td>
                                ...
                                <table width="596" border="0" align="center" cellpadding="0" cellspacing="0" class="note">
                                   ...
                                   <tr>
                                        <td valign="top">
                                            <a href="/WorkFlowCenter/FlowCharts/StoreSampling.doc" style="cursor:hand; color:Blue; font-size:14px">Click here to view the flowchart of the workflow</a>
                                        </td>
                                    </tr>
                                    <tr>
