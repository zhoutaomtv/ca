<%@ Page Title="" Language="C#" MasterPageFile="~/_Layouts/CA/Application.Master"
    AutoEventWireup="true" CodeBehind="UpdateForm.aspx.cs" Inherits="CA.WorkFlow.UI.SupplierReinspection.UpdateForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <QFL:ListFormControl ID="ListFormControl1" runat="server" FormMode="Display">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td>
                    <table width="680" border="0" align="left" cellpadding="0" cellspacing="1" class="workflower_table">
                        <tr>
                            <td>
                                Comments 批注:
